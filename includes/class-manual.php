...
class Cirrusly_Commerce_Manual {
    ...
    public static function render_page() {
        ...
        // Enqueue manual-specific styles
        wp_enqueue_style( 'cirrusly-admin-manual-css', CIRRUSLY_COMMERCE_URL . 'assets/css/admin-manual.css', array(), CIRRUSLY_COMMERCE_VERSION );
